...
<div class="card">
    ...
    <div class="card-body">
        <form action="{{ route("admin.conductores.update",[$conductor->id]) }}" method="POST" enctype="multipart/form-data">
            @csrf
             @method('PUT')
            <div class="form-group {{ $errors->has('nombre') ? 'has-error' : '' }}">
             ...
             <div class="form-group {{ $errors->has('licencia') ? 'has-error' : '' }}">
                ...
                <input type="text" id="licencia" name="licencia" class="form-control" value="{{ old('licencia', isset($conductor) ? $conductor->licencia : '') }}">
            </div>
